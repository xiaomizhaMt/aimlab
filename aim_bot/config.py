...
# Aim Lab 常见靶标颜色
# 橙色/黄色靶心
TARGET_ORANGE_LOWER = np.array([5, 150, 150])
TARGET_ORANGE_UPPER = np.array([25, 255, 255])

# 绿色靶标
TARGET_GREEN_LOWER = np.array([40, 100, 100])
TARGET_GREEN_UPPER = np.array([80, 255, 255])

# 红色靶标
TARGET_RED_LOWER1 = np.array([0, 150, 150])
TARGET_RED_UPPER1 = np.array([10, 255, 255])
TARGET_RED_LOWER2 = np.array([170, 150, 150])
TARGET_RED_UPPER2 = np.array([180, 255, 255])

# 蓝色靶标
TARGET_BLUE_LOWER = np.array([100, 100, 100])
TARGET_BLUE_UPPER = np.array([130, 255, 255])
